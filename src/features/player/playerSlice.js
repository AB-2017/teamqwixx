...
export const playerSlice = createSlice({
  ...
  initialState: {
    ...
    [
     ...
     [
        {position:1, value:2, color: GREEN, available: true, played:false},
        {position:2, value:3, color: GREEN, available: true, played:false},
        {position:3, value:4, color: GREEN, available: true, played:false},
        {position:4, value:5, color: GREEN, available: true, played:false},
        {position:5, value:6, color: GREEN, available: true, played:false},
        {position:6, value:7, color: GREEN, available: true, played:false},
        {position:7, value:8, color: GREEN, available: true, played:false},
        {position:8, value:9, color: GREEN, available: true, played:false},
        {position:9, value:10, color: GREEN, available: true, played:false},
        {position:10, value:11, color: GREEN, available: true, played:false},
        {position:11, value:12, color: GREEN, available: true, played:false},
        {position:12, value:'--|', color: GREEN, available: true, played:false},
      ],
    [
        {position:1, value:2, color: BLUE, available: true, played:false},
        {position:2, value:3, color: BLUE, available: true, played:false},
        {position:3, value:4, color: BLUE, available: true, played:false},
        {position:4, value:5, color: BLUE, available: true, played:false},
        {position:5, value:6, color: BLUE, available: true, played:false},
        {position:6, value:7, color: BLUE, available: true, played:false},
        {position:7, value:8, color: BLUE, available: true, played:false},
        {position:8, value:9, color: BLUE, available: true, played:false},
        {position:9, value:10, color: BLUE, available: true, played:false},
        {position:10, value:11, color: BLUE, available: true, played:false},
        {position:11, value:12, color: BLUE, available: true, played:false},
